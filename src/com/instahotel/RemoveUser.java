...
public class RemoveUser extends JFrame {
	 ...
	 */
	public RemoveUser() {
		setTitle("InstaHotel - Remove User");
		...
		UserDetailPanel.setBounds(10, 144, 664, 356);
		...
		button.setIcon(new ImageIcon(RemoveUser.class.getResource("/com/img/cancel.png")));
		button.setHorizontalTextPosition(SwingConstants.CENTER);
		button.setBorder(new EmptyBorder(0, 0, 0, 0));
		button.setBackground(new Color(233, 150, 122));
		button.setBounds(606, 301, 48, 44);
		UserDetailPanel.add(button);
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Statement st=null;
				ResultSet rs=null;
				String sql = "DELETE FROM uldetail WHERE UserName='"+tfSUserName.getText()+"'";
				try {
					st = con.createStatement();
					st.executeUpdate(sql);
					tfSUserName.setText("");
					UserDetailPanel.setVisible(false);
					HeadSPanel.infoBox("User has been Removed.", "Congratulations", JOptionPane.INFORMATION_MESSAGE);
		...
		button_1.setIcon(new ImageIcon(RemoveUser.class.getResource("/com/img/recycleBin.png")));
		button_1.setHorizontalTextPosition(SwingConstants.CENTER);
		button_1.setBorder(new EmptyBorder(0, 0, 0, 0));
		button_1.setBackground(new Color(233, 150, 122));
		button_1.setBounds(548, 301, 48, 44);
		UserDetailPanel.add(button_1);
	}
}
